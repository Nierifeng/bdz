<template>
  <div>
    ...
    >
      <template #buttons>
        <el-button type="primary" v-auth="'user.dept.add'" @click="addDept()">
          添加</el-button
        >
      </template>
...
async function onSearch() {
  loading.value = true;
  const { data } = await getDeptList(form);
